...
\begin{solution}
  ...
  \equiv x \pmod {a}$ and $x^\prime \equiv x \pmod {a}$, so $x^\prime
...
\begin{align*}
x^\prime \equiv x \pmod{a} \ \QAND\  x^\prime \equiv x \pmod{b}\text{   iff}\\
x^\prime \equiv x \pmod{ab}.
\end{align*}
\end{lemma*}
\end{solution}
...
that $f^{-1}(m,n)$ is the unique $x \in \Zintvco{a0}{ab}$
satisfying~\eqref{xma} and~\eqref{xnb}.
