...
\begin{pcomments}
  ...
  \pcomment{A little unclear and not that interesting --ARM 10/10/09;
    tweaked for clarity --ARM 5/13/18}}
\end{pcomments}
...
The network company regularly has to disconnect cables between servers
for testing and repair, but there are 23 high priority servers which
must always be able to transmit data to each other.
